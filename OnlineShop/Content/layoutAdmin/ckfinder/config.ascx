...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "ckfree";
        LicenseKey = "RQY6FJ3SUDJQ37RHPCS72XFJQ8XF382Q";
        ...
        BaseUrl = "/Media/";
        BaseDir = HttpContext.Current.Server.MapPath("~/Media/");
        ...
        //type = ResourceType.Add( "resource" );
        //type.Url = BaseUrl + "resource/";
        //type.Dir = BaseDir == "" ? "" : BaseDir + "resource/";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] {  "csv", "doc", "docx", "pdf","ppt", "pptx", "pxd",  "xls", "xlsx"};
        ...
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "mp4", "avi","mpeg", "mpg",};
        //type.DeniedExtensions = new string[] { };
