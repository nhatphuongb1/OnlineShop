...
namespace OnlineShop.AccessData.Utilities
{
    public class ConstantValues
    {
        ...
        public const string EMAIL_FROM_US = "contactcollectionbigstore@gmail.com";

        public const string EMAIL_TO_US = "bigstorerikkei@gmail.com";

        public const string PASSWORD_EMAIL_BIGSTORE = "(0123456789)";

        public const string STRING_EMAIL_SUBJECT = "[Big Store - Mail Us]";

        public const string STRING_EMAIL_SUCCESS = "Thank for your message";

        public const string STRING_DELETE_CONFIRM = "Are you sure you want to delete this? ";
